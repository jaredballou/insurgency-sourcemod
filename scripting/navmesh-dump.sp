...
{
	cvarVersion = CreateConVar("sm_navmesh_version", PLUGIN_VERSION, PLUGIN_DESCRIPTION, FCVAR_NOTIFY | FCVAR_PLUGIN | FCVAR_DONTRECORD);
	cvarEnabled = CreateConVar("sm_navmesh_enabled", "1", "sets whether bot naming is enabled", FCVAR_NOTIFY | FCVAR_PLUGIN);
...
bool:NavMeshLoad(const String:sMapName[],const String:sNavFile[]="")
{
