...
RegisterCvars()
{
	...
	hCvarExcludeBots = CreateConVar("sm_afk_exclude_bots", "0", "Should the AFK Manager exclude counting bots in player counts? [0 = FALSE, 1 = TRUE, DEFAULT: 0]", 0, true, 0.0, true, 1.0);
	hCvarExcludeDead = CreateConVar("sm_afk_exclude_dead", "0", "Should the AFK Manager exclude checking dead players? [0 = FALSE, 1 = TRUE, DEFAULT: 0]", 0, true, 0.0, true, 1.0);
